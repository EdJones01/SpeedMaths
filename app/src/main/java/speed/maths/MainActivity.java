...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(sharedPreferences.getInt("numberOfQuestions", 0) == 0) {
            editor.putString("allowedOperators", Game.ADD+Game.SUBTRACT+Game.MULTIPLY);
    ...
    Game createGameFromSharedPreferences() {
        ...
        return new Game(
                ...
                sharedPreferences.getString("allowedOperators", (Game.ADD+Game.SUBTRACT+Game.MULTIPLY)).split("")
        );
    }
